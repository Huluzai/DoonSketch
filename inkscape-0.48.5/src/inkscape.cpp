...
//        inkscape_exit (inkscape); //zhangguangjian
    }
}
...
#ifdef __APPLE__
    if (!homedir) {
        homedir = [NSHomeDirectory() UTF8String];
    }
#endif
    if (!homedir) {
...
#ifdef __APPLE__
    prefdir = [[NSHomeDirectory() stringByAppendingPathComponent:@"Resources"] UTF8String];    //zhangguangjian
#endif
