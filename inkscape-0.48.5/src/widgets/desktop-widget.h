...
struct SPDesktopWidget {
    ...
    struct WidgetStub : public Inkscape::UI::View::EditWidgetInterface {
        ...
        virtual void setCursor (SPCursorType cursor) {
            GdkCursor *c = sp_stock_gdk_cursor(cursor);
            gdk_window_set_cursor(SP_GTK_CANVAS_WINDOW(sp_desktop_canvas(_dtw->desktop)), c);
