...
namespace {
#if 0   // zhangguangjian , for remove_gc
...
Ops alternative_ops = {
    ...
    &GA_malloc,
    &GA_base,
    &GA_register_finalizer,
    &GA_general_register_disappearing_link,
    &GA_unregister_disappearing_link,
    &GA_get_heap_size,
    &GA_get_free_bytes,
    &GA_gcollect,
    &GA_enable,
...
#endif
        if (!std::strcmp(mode_string, "disable")) {
            return disabled_ops;
        } else if (!std::strcmp(mode_string, "alternative")) {
