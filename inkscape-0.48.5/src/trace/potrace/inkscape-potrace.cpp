...
//zhanggguangjian
static void (*pte_callback)(double progress, void *privdata) = potraceStatusCallback;

void setPortraceTracingEngionCallback(void (*callback)(double progress, void *privdata))
{
    pte_callback = callback;
}
...
PotraceTracingEngine::PotraceTracingEngine()
{
    ...
    potraceParams->progress.callback = pte_callback;//potraceStatusCallback;
