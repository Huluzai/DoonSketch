...
typedef Inkscape::UI::View::EditWidgetInterface* (*FunCreateEditWidgetWithDocument)(SPDocument *);
...
public:
    ...
    static void setEditWidgetCreateMethod(FunCreateEditWidgetWithDocument);
