...
static Inkscape::UI::View::EditWidgetInterface* createEditWidget(SPDocument *doc)
{
    return new Inkscape::UI::View::EditWidget(doc);
}
    
static FunCreateEditWidgetWithDocument _funCreateEditWidget = createEditWidget;
...
void
Editor::setEditWidgetCreateMethod(FunCreateEditWidgetWithDocument fun)
{
    _funCreateEditWidget = fun;
}
