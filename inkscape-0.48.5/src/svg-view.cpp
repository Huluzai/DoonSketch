...
SPSVGView::mouseover()
{
    ...
    gdk_window_set_cursor(SP_GTK_CANVAS_WINDOW(SP_CANVAS_ITEM(_drawing)->canvas), cursor);
...
SPSVGView::mouseout()
{
    gdk_window_set_cursor(SP_GTK_CANVAS_WINDOW(SP_CANVAS_ITEM(_drawing)->canvas), NULL);
}
